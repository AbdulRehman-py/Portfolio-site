...
const About = () => {
  return (
    <section id="about" className="flex flex-col exsmall:px-[4rem] px-[1.5rem]  gap-10 py-[8rem] sm:px-[4rem]  md:p-global pb-[4rem]">
<div >
        <h2 className="text-darkyel font-bold  text-3xl md:text-5xl font-k2d mb-2 ">About</h2>

        <p className="text-blue1 font-mono text-[0.9rem] md:text-lg ">
